...
- **Phase 2: Dedicated Utility Rows**: Message buses and databases are excluded from Kahn's sort and reinserted into purpose-built rows. Busy buses widen into clear spines; high-connectivity buses are corner-anchored in the bottom-right when useful. Databases sit in tighter rows beneath their deepest contributing service.
...
- 🧭 **Dedicated Bus & Database Rows**: Message buses and databases are separated from ordinary service layers, with high-connectivity buses able to anchor in the bottom-right and databases visually paired beneath their owner service.
...
- 🔌 **Hybrid Edge Routing**: Cross-boundary and internal boundary edges compare direct, row-gap, and gutter candidates. Node crossings are avoided as a hard priority, while shared edge corridors and edge-edge crossings are reduced with weighted scoring.
